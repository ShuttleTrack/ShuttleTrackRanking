...
export const checkInButtonPrimary = 'bg-primary text-black shadow-lg shadow-primary/20';
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
      <button
        ...
        className={`${checkInButtonBase} ${inSelected ? checkInButtonPrimary : checkInButtonIdle}`}
        onClick={() => onVote('IN')}
