...
**Remaining routes to cut over** (not started): `pages/api/players/[id].ts` (PUT), `pages/api/players/[id]/activate.ts`, `pages/api/players/[id]/encounters.ts`, `pages/api/game/players.ts`, `pages/api/admin/players.ts`, `pages/api/encounters/history.ts`, `pages/api/rankings/index.ts`, `pages/api/rankings/history.ts`, `pages/api/players/index.ts`'s `POST` branch, `pages/api/games/[id]/submit.ts`, `pages/api/games/[id]/process.ts`. Each should get its own deliberate swap-deploy-validate cycle, same as this one - not batched.
